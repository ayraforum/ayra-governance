...
The Ayra Working Group [Participation Policies](/governance-bodies/working-groups/guidance/guiding-policies.md#participation-policies) apply.

### Code of Conduct

All participants must follow the Ayra [Code of Conduct](/governance-artifacts/code-of-conduct.md).
...
This WG follows the general Ayra guidance for [Decisions](/governance-bodies/working-groups/guidance/guiding-policies.md#decision-policies) with no changes.

## Intellectual Property Rights  {#5.-intellectual-property-rights}

* **Copyright Mode**: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.en).   
...
## **6\. About This Charter**

| Charter Period | Start Date | End Date | Changes |
| :---- | :---- | :---- | :---- |
| **Initial Charter** | DD/MM/YYYY | DD/MM/YYYY | None |
| **Charter Extension** | DD/MM/YYYY | DD/MM/YYYY |  |
| **Rechartered** | DD/MM/YYYY | DD/MM/YYYY |  |


## **Ayra Working Group Charter Template** 

This Working Group Charter is based on the [Working Group Charter Template](/governance-artifacts/templates/wg-charter-template.md)
